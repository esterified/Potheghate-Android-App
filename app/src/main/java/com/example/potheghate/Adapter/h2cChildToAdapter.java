...
public class h2cChildToAdapter extends RecyclerView.Adapter<h2cChildToAdapter.viewHolder> {
    ...
    public h2cChildToAdapter(ArrayList<c_data_to> data_to, HashMap<String, ArrayList<c_price>> price_all, HashMap<String, ArrayList<c_price>> price_all_courier,ArrayList<c_data_from> data_from) {
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new h2cChildToAdapter.viewHolder(view);
